...
class PrefillAdder:
    ...
    def _add_one_req(
        ...
        return CLS(
            ...
            workflow_metadata=pending_req.workflow_metadata
        )
...
class PrefillManager:
    ...
    def add_one_req(self, req: UserMsg) -> None:
        self.pending_list.append(PendingReq(req.uid, req.input_ids, req.sampling_params, workflow_metadata=req.workflow_metadata))
